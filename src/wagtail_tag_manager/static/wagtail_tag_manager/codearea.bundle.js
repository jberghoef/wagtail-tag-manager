...
/* harmony import */ var codemirror_mode_django_django__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! codemirror/mode/django/django */ "./node_modules/codemirror/mode/django/django.js");
/* harmony import */ var codemirror_mode_django_django__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(codemirror_mode_django_django__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var codemirror_addon_display_panel__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! codemirror/addon/display/panel */ "./node_modules/codemirror/addon/display/panel.js");
/* harmony import */ var codemirror_addon_display_panel__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(codemirror_addon_display_panel__WEBPACK_IMPORTED_MODULE_4__);
...
var Codearea = /** @class */ (function () {
    ...
    Codearea.prototype.initialize = function () {
        var _this = this;
        this.editor = codemirror__WEBPACK_IMPORTED_MODULE_2__.fromTextArea(this.el, { mode: "django" });
        fetch("/wtm/variables/")
        ...
        for (var _i = 0, data_1 = data; _i < data_1.length; _i++) {
            ...
            for (var _a = 0, _b = group.items; _a < _b.length; _a++) {
                ...
                a.addEventListener("click", function (event) {
                    ...
                    _this.editor.doc.replaceSelection("{{ ".concat(target.dataset.key, " }}"), "end");
                    _this.editor.focus();
                });
